...
export const fragments = {
  resultFragment: gql`
    fragment ToDoItemResult on ToDoItem {
      name
      updatedBy
      description
      updatedAt
  ...
  `,
  fullFragment: gql`
    fragment ToDoItemFull on ToDoItem {
      name
      updatedBy
      description
      updatedAt
...
export const queries = {
  ...
  getMany: ({ fullFragment }) => gql`
    query ToDoItems($filter: ToDoItemComplexFilter) {
  ...
  update: ({ fullFragment }) => gql`
    mutation updateToDoItem($input: updateToDoItemInput!) {
