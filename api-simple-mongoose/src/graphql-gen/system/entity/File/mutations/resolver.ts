...
async function linkToUser({ context, user, file }) {
  if (user) {
...
async function unlinkFromUser({ context, user, file }) {
  if (user) {
    await context.userGQL({
      query: gql`
...
async function unlinkFileFromAll(
  args: {
    key;
    type;
    value;
...
export const mutation = {
  createFile: mutateAndGetPayload(
    async (
      args: {
        id?: string;
        path?: string;
  ...
  updateFile: mutateAndGetPayload(
    async (
      args: {
        id?: string;
        path?: string;
  ...
  deleteFile: mutateAndGetPayload(
    async (
      args: {
        id?: string;
        path?: string;
