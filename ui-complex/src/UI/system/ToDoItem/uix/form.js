  ...
  render() {
    ...
    return (
      <SimpleForm {...props} >
        ...
        <DateInput label="resources.ToDoItem.fields.createdAt" source="createdAt"  allowEmpty />
        <DateInput label="resources.ToDoItem.fields.updatedAt" source="updatedAt"  allowEmpty />
