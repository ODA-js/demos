...
export const fragments = {
  resultFragment: gql`fragment ToDoItemResult on ToDoItem {
    ...
    createdById: createdBy @_(get:"id") {
      id
    }
    updateById: updateBy @_(get:"id") {
      id
    }
  }`,
...
export const queries = {
  ...
  `,
    ...
    createdBy: gql`query CreatedBy_Id($skip: Int, $limit: Int, $orderBy: [ToDoItemSortOrder], $filter: ToDoItemComplexFilter) {
      items: toDoItems(skip:$skip, limit: $limit, orderBy: $orderBy, filter: $filter) {
        pageInfo {
          count
        }
  ...
  `,
    ...
    updateBy: gql`query UpdateBy_Id($skip: Int, $limit: Int, $orderBy: [ToDoItemSortOrder], $filter: ToDoItemComplexFilter) {
      items: toDoItems(skip:$skip, limit: $limit, orderBy: $orderBy, filter: $filter) {
        pageInfo {
          count
        }
  ...
  getManyReferenceResult: ({ resultFragment }, { getManyReferenceResultOpposite, getManyReferenceResultRegular }) => ({
    ...
    createdBy: getManyReferenceResultRegular({ resultFragment }),
    updateBy: getManyReferenceResultRegular({ resultFragment }),
  }),
}
